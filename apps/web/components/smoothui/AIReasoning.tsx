	...
	return (
		<div className={cn("w-full my-1.5", className)}>
			<button
				...
				className="group flex w-full cursor-pointer items-center gap-1.5 rounded-lg py-1 px-1.5 text-left text-zinc-400 text-xs transition-colors hover:text-zinc-200 bg-[#14171c]/60 border border-[rgba(255,255,255,0.05)] active:scale-95"
				onClick={() => {
